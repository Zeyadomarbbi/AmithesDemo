...
/**
 * Component to render a sortable table header, replacing the original TableSort component.
 * It uses the internal SortIcon and manages the click handler.
 * @param {string} label - The column label text.
 * @param {string} columnKey - The key to use for sorting.
 ...
 * @param {boolean} right - Flag for right alignment class.
 * @param {boolean} showCurrency - Flag to show currency indicator.
 */
export function SortableHeaderRenderer({ label, columnKey, currentSortKey, currentSortDir, toggleSort, right = false, showCurrency = false }) {
