...
import DatePicker from './DatePicker'; // Assuming your large DatePicker code is in this file
import './DatePicker.css'; // Your CSS file
...
const DateInputWithPicker = ({ 
  ...
  return (
    <div className="date-input-container" ref={containerRef} style={{ position: 'relative', display: 'inline-block' }}>
      ...
      {/* 2. The Popover (Rendered Conditionally) */}
      {isOpen && (
